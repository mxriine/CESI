...
$sqlentreprise = "SELECT COUNT(*) AS totalEntreprises FROM Company";
...
$sqloffre = "SELECT COUNT(*) AS totalOffres FROM Offer";
...
$sqletudiant = "SELECT COUNT(*) AS totalEtudiants FROM Student";
