...
<body>
    ...
    <div class="scroll-section">
        <div class="scroll-content">
            ...
            <div class="place">
                <a href="../Modification/modifier_Pilote.html"><button class="bouton-droite2" type="button">Modifier</button></a>
                <a href="../Supprimer/supprimer_Pilote.html"><button class="bouton-droite2" type="reset">Supprimer</button></a>
            </div>
        </div>
        <div class="scroll-content">
            <div class="Titrestage">
