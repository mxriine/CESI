...
<body>
    ...
    <div id="BLOC_INSCRIPTION1" style="display: none;">
        <section class="container">
            <div class="title">
                <h1>CREER UN PILOTE</h1>
    ...
    <div id="BLOC_INSCRIPTION2">
        <section class="container">
            <div class="title">
                <h1>Création compte Pilote</h1>
                <p for="Etape1">Etape 2: Informations personnelles</p>
            </div>
        ...
        <section class="promotion" id="promotion">
            <label>Promotion assignées</label>
            <div>
                <input type="checkbox" id="1A" name="promo" value="1A">
                <label for="1An">1ère année</label>
            </div>
            <div>
                <input type="checkbox" id="2A" name="promo" value="2A">
                <label for="2An">2ème année</label>
            </div>
            <div>
                <input type="checkbox" id="3A" name="promo" value="3A">
                <label for="3An">3ème année</label>
            </div>
            <div>
                <input type="checkbox" id="4A" name="promo" value="4A">
                <label for="4An">4ème année</label>
            </div>
            <div>
                <input type="checkbox" id="5A" name="promo" value="5A">
                <label for="5An">5ème année</label>
            </div>
        </section>

        <section class="centre">
            <p for="labelEtape1">Centre</p>
            <select>
        ...
        <button class="bouton" id="boutonValidationInscriptionPilote2" type="submit">VALIDER</button>
        <p id="messageErreurChamps3"></p>
    </div>
</body>
