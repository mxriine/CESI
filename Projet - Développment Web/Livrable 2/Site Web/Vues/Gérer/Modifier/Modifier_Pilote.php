   ...
   <section class="bloc">
        ...
        <article class="contenu">
            ...
            <div class="promotion" id="promosP">
                ...
                <label for="2A">2e année</label>
                <input type="checkbox" name="promosP" value="3A">
                <label for="3A">3e année</label>
                <input type="checkbox" name="promosP" value="4A" checked>
                <label for="4A">4e année</label>
                <input type="checkbox" name="promosP" value="5A">
        ...
        <article class="boutons-G">
            <a href="/Gérer/Supprimer/Supprimer_Pilote.html"><button type="button" id="but3">Supprimer le pilote</button></a>
        </article>
   </section>
